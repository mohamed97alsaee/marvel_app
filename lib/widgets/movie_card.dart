              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                   children: [
                  Text(   marvelMovieModel.duration.toString(), style: const TextStyle(color: Colors.white , fontSize: 14 , fontWeight: FontWeight.w300),),
                   Text(marvelMovieModel.title , style: const TextStyle(color: Colors.white , fontSize: 14 , fontWeight: FontWeight.w500),),
                          
                ],),
              ),
            ),child: Image.network(marvelMovieModel.coverUrl,  fit: BoxFit.cover,) ,),
          );
